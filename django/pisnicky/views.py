...
def p6(request):
	return render(request, 'Až_Mi_Bude_Pìtašedesát.html')
...
def p57(request):
	return render(request, 'Kdo_Vchází_Do_Tvých_Snù_Má_Lásko.html')

def p58(request):
	return render(request, 'Když_Nemùžeš_Tak_Pøidej.html')

def p59(request):
	return render(request, 'Krátke_Lásky.html')

def p60(request):
	return render(request, 'Køídla_Z_Mýdla.html')
...
def p105(request):
	return render(request, 'Sbírka_Zvadlejch_Rùží.html')
...
def p111(request):
	return render(request, 'Svaz_Èeských_Bohémù.html')
...
def p119(request):
	return render(request, 'Tøi_Køíže.html')
