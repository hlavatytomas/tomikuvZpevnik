...
urlpatterns = [
	...
	path('docs/songs/Andìl.html', views.p4, name='Andìl'),
	path('docs/songs/Ani_K_Stáru.html', views.p5, name='Ani_K_Stáru'),
	path('docs/songs/Až_Mi_Bude_Pìtašedesát.html', views.p6, name='Až_Mi_Bude_Pìtašedesát'),
	...
	path('docs/songs/Budu_Všechno_Co_Si_Budeš_Pøát.html', views.p16, name='Budu_Všechno_Co_Si_Budeš_Pøát'),
	...
	path('docs/songs/Cesta_Z_Mìsta.html', views.p19, name='Cesta_Z_Mìsta'),
	path('docs/songs/Chci_Zas_V_Tobì_Spát.html', views.p20, name='Chci_Zas_V_Tobì_Spát'),
	path('docs/songs/Co_Z_Tebe_Bude.html', views.p21, name='Co_Z_Tebe_Bude'),
	path('docs/songs/Èarodìjnice_Z_Amesbury.html', views.p22, name='Èarodìjnice_Z_Amesbury'),
	path('docs/songs/Èerní_andìlé.html', views.p23, name='Èerní_andìlé'),
	...
	path('docs/songs/Dlouhej_Kouø.html', views.p27, name='Dlouhej_Kouø'),
	...
	path('docs/songs/Grónská_písnièka.html', views.p37, name='Grónská_písnièka'),
	...
	path('docs/songs/Hlídaè_Krav.html', views.p42, name='Hlídaè_Krav'),
	path('docs/songs/Hlupák_Váhá.html', views.p43, name='Hlupák_Váhá'),
	path('docs/songs/Holky_To_Objektivnì_Lehèí_Maj.html', views.p44, name='Holky_To_Objektivnì_Lehèí_Maj'),
	...
	path('docs/songs/Jdou_Po_Mnì_Jdou.html', views.p54, name='Jdou_Po_Mnì_Jdou'),
	path('docs/songs/Jožin_Z_Bažin.html', views.p55, name='Jožin_Z_Bažin'),
	path('docs/songs/Každý_Ráno.html', views.p56, name='Každý_Ráno'),
	path('docs/songs/Kdo_Vchází_Do_Tvých_Snù_Má_Lásko.html', views.p57, name='Kdo_Vchází_Do_Tvých_Snù_Má_Lásko'),
	path('docs/songs/Když_Nemùžeš_Tak_Pøidej.html', views.p58, name='Když_Nemùžeš_Tak_Pøidej'),
	path('docs/songs/Krátke_Lásky.html', views.p59, name='Krátke_Lásky'),
	path('docs/songs/Køídla_Z_Mýdla.html', views.p60, name='Køídla_Z_Mýdla'),
	path('docs/songs/Kupte_Si_Høebeny.html', views.p61, name='Kupte_Si_Høebeny'),
	...
	path('docs/songs/Mám_Doma_Koèku.html', views.p76, name='Mám_Doma_Koèku'),
	...
	path('docs/songs/Mùj_Svìt.html', views.p84, name='Mùj_Svìt'),
	...
	path('docs/songs/Promìny.html', views.p99, name='Promìny'),
	...
	path('docs/songs/Sbírka_Zvadlejch_Rùží.html', views.p105, name='Sbírka_Zvadlejch_Rùží'),
	path('docs/songs/Sbohem_Galáneèko.html', views.p106, name='Sbohem_Galáneèko'),
	...
	path('docs/songs/Svaz_Èeských_Bohémù.html', views.p111, name='Svaz_Èeských_Bohémù'),
	path('docs/songs/Šaman.html', views.p112, name='Šaman'),
	path('docs/songs/Šrouby_A_Matice.html', views.p113, name='Šrouby_A_Matice'),
	path('docs/songs/Tìšínská.html', views.p114, name='Tìšínská'),
	...
	path('docs/songs/Tøi_Køíže.html', views.p119, name='Tøi_Køíže'),
	...
	path('docs/songs/Vèelín.html', views.p123, name='Vèelín'),
	path('docs/songs/Veï_mì_dál,_cesto_má.html', views.p124, name='Veï_mì_dál,_cesto_má'),
	...
	path('docs/songs/Zalùbení.html', views.p135, name='Zalùbení'),
